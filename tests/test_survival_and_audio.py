...
def test_two_seat_configuration():
    ...
    assert driver_seat["position"] == [-0.45, 1.65, 0.15], "Driver seat must be on the left"
    assert passenger_seat["position"] == [0.45, 1.65, 0.15], "Passenger seat must be on the right"
